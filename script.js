...
document.addEventListener('DOMContentLoaded', () => {
  // Helper function to generate a dropdown for updating report status
  ...
  function renderAdminReports() {
      ...
      reports.forEach(report => {
          ...
          li.innerHTML = `
            ...
            <p><strong>Submitted By:</strong> ${report.userEmail}</p>
  ...
  // Admin: Update Report Status using event delegation on the admin reports container
  document.getElementById('admin-reports-container').addEventListener('click', (e) => {
      if (e.target.classList.contains('update-status-btn')) {
          ...
          if (report) {
              ...
              // Optionally update the user reports view if needed
